...
// Screen after clicked hardpoint mode
public class Hardpoint extends Component implements MouseMotionListener, MouseListener, ActionListener
{
   ...
   *****************************************************************/
   ...
   class Drawing extends JComponent
   {
      ...
      public void paint(Graphics g)
      {
         ...
         g.drawString("H A R D P O I N T", 379-40, 154);
         
         
         g.setColor(new Color(110,156,110));
         g.drawString("H A R D P O I N T", 385-40, 150);
   ...
   public void mouseReleased(MouseEvent e) 
   {
      ...
      {        
         vis = false;
         new CustomMapOneHardpoint(4,0,0, 1000,1000,1, playupto);
         isVis();                
      } 
      ...
      {     
         vis = false;
         new CustomMapOneHardpoint(4,0,0, 1000,1000,2,playupto);
         isVis();        
      } 
      ...
      {        
         vis = false;
         new CustomMapOneHardpoint(4,0,0, 1000,1000,0,playupto);
         isVis();                
      } 
