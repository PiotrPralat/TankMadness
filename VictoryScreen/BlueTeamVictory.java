...
// Victory Screens
public class BlueTeamVictory extends Component implements MouseMotionListener, MouseListener  
{     
   ...
   *****************************************************************/
   ...
   // Victory Screen for blue team
   public BlueTeamVictory(int numberoftanks, int teamonepoints, int teamtwopoints)
   {
   ...
   class Drawing extends JComponent
   {
      ...
      public void paint(Graphics g)
      {
         ...
         if(numberoftanks > 2)
         {
            g.drawImage(blueTank.getImage(),60,450,380,290,this);
            g.drawImage(yellowTank.getImage(),465,450,380,290,this);
            g.drawImage(redTank.getImage(),990,100,180,130,this);
            g.drawImage(purpleTank.getImage(),780,100,180,130,this);
         }
         
         
         if(numberoftanks <= 2)
         {
            g.drawImage(blueTank.getImage(),270,450,380,290,this);
            g.drawImage(redTank.getImage(),870,100,180,130,this);
         }
         ...
         g.setColor(Color.black);
         g.drawString(Integer.toString(teamtwopoints), 421,839);
          
         g.setColor(new Color(255,204,0));
         g.drawString(Integer.toString(teamtwopoints), 427,835);
         
         Font scoreL = new Font("impact", Font.PLAIN, 50);
         g.setFont(scoreL);         
         g.setColor(Color.black);
         g.drawString(Integer.toString(teamonepoints), 965,280);   
